...
\begin{figure}
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_1a_throughputMemtier.eps}
        \caption{Throughput, read only}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_1b_throughputMemtier.eps}
        \caption{Throughput, write only}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_1a_latencyMemtier.eps}
        \caption{Response Time, read only}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_1b_latencyMemtier.eps}
        \caption{Response Time, write only}
    \end{subfigure}

    \caption{Baseline Without Middleware, One Server}
    \label{fig:2-1}
\end{figure}
...
\begin{figure}
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_2a_throughputMemtier.eps}
        \caption{Throughput, read only}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_2b_throughputMemtier.eps}
        \caption{Throughput, write only}
    \end{subfigure}
    
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_2a_latencyMemtier.eps}
        \caption{Response Time, read only}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \includegraphics[width=1\linewidth]{plots/2_2b_latencyMemtier.eps}
        \caption{Response Time, write only}
    \end{subfigure}

    \caption{Baseline Without Middleware, Two Servers}
    \label{fig:2-2}
\end{figure}
\subsubsection{Explanation}
