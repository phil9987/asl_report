...
\begin{table}
    \begin{subtable}{.5\linewidth}\centering
        {\begin{tabular}{|ccc|}
            \hline
            \textbf{CPU} & \textbf{Send} & \textbf{Receive}\\
            11.17\%         & 12.47 MB/s    & 0.44 MB/s\\
            \hline
        \end{tabular}
        \caption{Server, read-only, 6 memtier clients in total}}
    \end{subtable}
    \begin{subtable}{.5\linewidth}\centering
        {\begin{tabular}{|ccc|}
            \hline
            \textbf{CPU} & \textbf{Send} & \textbf{Receive}\\
            11.00\%        & 0.42 MB/s     & 12.96 MB/s\\
            \hline
        \end{tabular}
        \caption{Server, write-only,  12 memtier clients in total}}
    \end{subtable}
    \begin{subtable}{.5\linewidth}\centering
        {\begin{tabular}{|ccc|}
            \hline
            \textbf{Avg CPU} & \textbf{Avg Send} & \textbf{Avg Receive}\\
            23.50\%           & 0.87 MB/s     & 25.01 MB/s\\
            \hline
        \end{tabular}
        \caption{Clients, read-only, 6 memtier clients in total}}
    \end{subtable}
    \begin{subtable}{.5\linewidth}\centering
        {\begin{tabular}{|ccc|}
            \hline
            \textbf{Avg CPU} & \textbf{Avg Send} & \textbf{Avg Receive}\\
            15.98\%       & 24.80 MB/s     & 0.83 MB/s\\
            \hline
        \end{tabular}
        \caption{Clients, write-only, 12 memtier clients in total}}
    \end{subtable}
